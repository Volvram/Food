              ...
              <div className={s.calendar_card_inner}>
                ...
                <div className={s.calendar_card_inner_card}>
                  <div className={s.calendar_card_inner_card_title}>
                    <div className={s.calendar_card_inner_card_title_circle}>
                      <svg
                    ...
                    <div className={s.calendar_card_inner_card_title_text}>
                      Lorem ipsum dolor sit amet.
                    </div>
                  </div>
                  <div className={s.calendar_card_inner_card_data}>
                    <div className={s.calendar_card_inner_card_data_gram}>
                      210г
                    </div>
                    <div className={s.calendar_card_inner_card_data_ccal}>
                      120ккал
                    </div>
                  </div>
                  <div className={s.calendar_card_inner_card_date}>
                    <div className={s.calendar_card_inner_card_date_calendar}>
                      <>
                        <svg
                          width="16"
                          height="17"
                    ...
                    21 дек 14:00
                    <div className={s.calendar_card_inner_card_date_tag}>
                      <>
                        <svg
                          width="15"
                          height="15"
